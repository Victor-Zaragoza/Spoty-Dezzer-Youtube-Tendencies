...
document.addEventListener("DOMContentLoaded", async function (event) {
	...
	fetch('//192.168.10.102:3000/saveinfo/')
	fetch('//192.168.10.102:3000/saveinfospotify/')
	fetch('//192.168.10.102:3000/saveinfoYoutube/')
})
...
async function YoutubeRequest(){
	...
	const EncabezadoYT=document.getElementById('EncabezadoYT');
	DivYT.innerHTML=''
	var playlist='';
	var nombre3='';
	var contenido='';
